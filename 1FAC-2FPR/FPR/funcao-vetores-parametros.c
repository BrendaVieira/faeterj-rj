*leonardo.vianna@faeterj-rio.edu.br*
...
RESULTADO:
a = 10, b=5.7;
a = 10, b=5.7; -> é necessário a aplicação de ponteiro/return na funcao
porque a memoria alocada para cada valor esta sendo alterada apenas na funcao,
sendo que esses valores precisam ser alteradosna main
MODIFICAR
...
* RETORNO e VETOR
	* vetor: variavel que armazena varios valores ao mesmo tempo
	`float notas[30];`
